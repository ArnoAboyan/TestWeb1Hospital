...
<header>
  <nav class="navbar navbar-expand-lg" style="position: fixed; left: 0; width: 100%; top: 0; background-color: #e3f2fd;">
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        <a href="controller?command=hospitalcardlist&page=1" style="background-color: #e3f2fd;" class="btn btn-outline-secondary" role="button" ><fmt:message key="admin_jsp.hospitalcard<Back"/></a>
        </button>
      </div>
      </div>
